...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { card_id_id: @price.card_id_id, ck_price: @price.ck_price, tcg_price: @price.tcg_price } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { card_id_id: @price.card_id_id, ck_price: @price.ck_price, tcg_price: @price.tcg_price } }
